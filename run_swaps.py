...
if __name__ == '__main__':
    ...
    parser.add_argument("--websites", default='swap_syncswap', help="The transaction types at the website you want to perform")
    ...
    if args.list:
        ...
        websites = [modules_settings.__dict__[action] for action in args.websites.split(" ")]
